...
use crate::entity::data::girls::ethel::perks::*;
use crate::entity::data::girls::nema::perks::*;
use crate::entity::data::npc::bellplant::LurePerk;
    ...
    ($character: expr, $perk_pattern: pat) => {{
	    'outer: loop {             
		    ...
		    for effect in $character.persistent_effects.iter() { 
			    if let crate::effects::PersistentEffect::TemporaryPerk { perk, .. } = effect
