...
impl PersistentEffect {
	pub(in crate) fn tick_all(
		mut owner: CombatCharacter, 
		others: &mut HashMap<Uuid, Entity>,
		rng: &mut Xoshiro256PlusPlus, 
		delta_ms: SaturatedU64
	) {
	...
	fn tick_next(
		mut owner: CombatCharacter,
		mut iter: impl Iterator<Item = PersistentEffect>, 
		others: &mut HashMap<Uuid, Entity>,
		rng: &mut Xoshiro256PlusPlus, 
		delta_ms: SaturatedU64
	) {
